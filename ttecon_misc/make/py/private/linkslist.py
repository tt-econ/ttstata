...
from make.py.private.linkdirectives import LinkDirectives
from make.py.private.preliminaries import input_to_array, print_error, files_list
...
class LinksList(object):
    ...
    def __init__(self, file_list, links_dir='@DEFAULTVALUE@'):
        ...
        self.links_files = []
        for f1 in file_list:
            if re.search('\*.+', f1) or re.search('^.+\*', f1) \
                    or re.search('\*', f1):
                # Make wildcard list
